...
namespace Pim\Component\Pim\Administrator\Table;
...
class ItemTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
    ...
    {
        $this->typeAlias = 'com_pim.item';
        parent::__construct('#__pim_items', 'id', $db);
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if (!$user->authorise('core.admin', 'com_pim.item.' . $array['id'])) {
            ...
            $default_actions = Access::getAssetRules('com_pim.item.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    protected function _getAssetParentId($table = null, $id = null)
    {
        ...
        $assetParent->loadByName('com_pim');
