...
namespace Pim\Component\Pim\Administrator\Model;
...
class ItemModel extends AdminModel
{
    ...
    public function duplicate(&$pks)
    {
        ...
        // Access checks.
        if (!$user->authorise('core.create', 'com_pim')) {
    ...
    protected function prepareTable($table)
    {
        ...
        if (empty($table->id)) {
            ...
            if (@$table->ordering === '') {
                $db = $this->getDbo();
                $db->setQuery('SELECT MAX(ordering) FROM #__pim_items');
                $max = $db->loadResult();
