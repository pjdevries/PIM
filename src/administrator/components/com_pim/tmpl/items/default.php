...
if (!empty($saveOrder))
{
	$saveOrderingUrl = 'index.php?option=com_pim&task=items.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
	HTMLHelper::_('draggablelist.draggable');
}

?>

<form action="<?php echo Route::_('index.php?option=com_pim&view=items'); ?>" method="post"
