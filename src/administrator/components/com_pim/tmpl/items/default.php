...
$canOrder = $user->authorise('core.edit.state', 'com_pim');

$saveOrder = $listOrder == 'a.ordering';

if (!empty($saveOrder)) {
    $saveOrderingUrl = 'index.php?option=com_pim&task=items.saveOrderAjax&tmpl=component&' . Session::getFormToken(
        ) . '=1';
        ...
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <table class="table table-striped" id="itemList">
                    ...
                    <tbody <?php
                    if (!empty($saveOrder)) : ?> class="js-draggable" data-url="<?php
                    echo $saveOrderingUrl; ?>" data-direction="<?php
                    echo strtolower($listDirn); ?>" <?php
                    endif; ?>>
                    <?php
                    foreach ($this->items as $i => $item) :
                        $ordering = ($listOrder == 'a.ordering');
                        $canCreate = $user->authorise('core.create', 'com_pim');
                        ...
                        echo $i % 2; ?>" data-draggable-group='1' data-transition>
                            ...
                            <td class="text-center">
                                <?php
                                echo HTMLHelper::_('jgrid.published', $item->state, $i, 'items.', $canChange, 'cb'); ?>
                            </td>
                            ...
                            <td>
                                ...
                                if ($canEdit) : ?>
                                    <a href="<?php
                                    echo Route::_('index.php?option=com_pim&task=item.edit&id=' . (int)$item->id); ?>">
                                        <?php
                ...
                <input type="hidden" name="list[fullorder]" value="<?php
                echo $listOrder; ?> <?php
                echo $listDirn; ?>"/>
                <?php
